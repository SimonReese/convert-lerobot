...
import lerobot
assert lerobot.__version__ == "0.1.0", f"Error: this script requires lerobot v0.1.0 but v{lerobot.__version__} was found instead"
...
LEROBOT_REPO_ID_V2 = "SimonReese/lerobot-20-ep-v2"
LEROBOT_DATASET_ROOT_V2 = "./datasets/lerobot/v2/lerobot-20-ep-v2"
...
def main():
    ...
    lerobot_dataset = LeRobotDataset.create(
        repo_id=LEROBOT_REPO_ID_V2,
        fps=10,
        features=FEATURES_DICT,
        root=LEROBOT_DATASET_ROOT_V2,
        robot_type="panda"
    )
